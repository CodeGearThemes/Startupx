 ...
 * @package Startupx
 */
$startupx_content_class   = startupx_archive_grid();
?>

<article id="post-<?php the_ID(); ?>" <?php post_class('article post-card grid__item '.esc_attr( implode( ' ', $startupx_content_class ) ) );?>  >
