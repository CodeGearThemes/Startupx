 ...
 */
class Startupx_Theme_Dashboard {
	...
	public $settings = array(
		'promo_link'          => '#',
		'review_link'         => 'https://wordpress.org/support/theme/startupx/reviews',
		'changelog_link'      => 'https://www.codegearthemes.com/products/startupx',
		'suggest_idea_link'   => '#',
		'support_link'        => 'https://wordpress.org/support/theme/startupx',
		'support_pro_link'    => '#',
		'community_link'      => '#',
		'documentation_link'  => '#',
	);
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_startupx_install_starter_plugin', array( $this, 'install_starter_plugin' ) );
		add_action( 'wp_ajax_nopriv_startupx_install_starter_plugin', array( $this, 'install_starter_plugin' ) );
	...
	public function add_menu_page() {
		add_submenu_page( 'themes.php', esc_html__( 'Startupx', 'startupx' ), esc_html__( 'Startupx', 'startupx' ), 'manage_options', $this->menu_slug, array( $this, 'welcome' ), 1 ); // phpcs:ignore WPThemeReview.PluginTerritory.NoAddAdminPages.add_menu_pages_add_submenu_page
	}

    public function admin_scripts() {

        wp_register_style( 'startupx-admin-style', get_template_directory_uri() . '/assets/admin/css/admin-style.css', false, STARTUPX_THEME_VERSION );
        wp_enqueue_style( 'startupx-admin-style' );

		wp_enqueue_script( 'startupx-admin-script', get_template_directory_uri() . '/assets/admin/js/admin-script.js', array(), STARTUPX_THEME_VERSION, true );

		wp_localize_script( 'startupx-admin-script', 'startupx_localize', array(
			'ajax_url'       => admin_url( 'admin-ajax.php' ),
			'nonce'          => wp_create_nonce( 'nonce' ),
			'failed_message' => esc_html__( 'Something went wrong, contact support.', 'startupx' ),
		) );
	...
	public function install_starter_plugin() {
		...
		if ( ! current_user_can( 'install_plugins' ) ) {
			wp_send_json_error( esc_html__( 'Insufficient permissions to install the plugin.', 'startupx' ) );
			wp_die();
		}
		...
		wp_send_json_error( esc_html__( 'Failed to initialize or activate importer plugin.', 'startupx' ) );
						...
						<div class="section--hero-image">
							<div class="hero-content">
								<div class="hero--user-welcome">
									<?php esc_html_e( 'Hello, ', 'startupx' ); ?>
									<?php
										$current_user = wp_get_current_user();
										echo esc_html( $current_user->display_name );
									?>
									<?php esc_html_e( '👋', 'startupx' ); ?>
								</div>

								<div class="hero-title">
									<?php esc_html_e( 'Welcome to Startupx', 'startupx' ); ?>
									<?php if ( !$this->pro_status ) { ?>
										<span class="badge badge-success"><?php esc_html_e( 'free', 'startupx' ); ?></span>
									<?php } else { ?>
										<span class="badge badge-success"><?php esc_html_e( 'pro', 'startupx' ); ?></span>
									<?php } ?>
								</div>
								<div class="hero-description">
									<?php esc_html_e('Startupx is now installed and ready to go. To help you with the next step, we have gathered together on this page all the resources you might need. We hope you enjoy using Startupx.', 'startupx'); ?>
								</div>
								...
								<div class="hero-actions">
									...
									<?php esc_html_e( 'Starter Sites', 'startupx' ); ?>					
									</a>
									...
									<?php if ( 'themes.php' === $pagenow && 'themes' === $screen->base ) { ?>
										<a href="<?php echo esc_url( add_query_arg( 'page', $this->menu_slug, admin_url( 'themes.php' ) ) ); ?>" class="button">
											<?php esc_html_e( 'Theme Dashboard', 'startupx' ); ?>
										</a>
									<?php } ?>
									<?php if ( 'active' !== $this->get_plugin_status( $this->starter_plugin_path ) ) { ?>
										<p class="hero-info">
											<?php esc_html_e( 'Clicking “Starter Sites” button will install and activate the  codegear starter plugin.', 'startupx' ); ?>
										</p>
									<?php } ?>
								</div>
							</div>
			...
			<div class="codegear-header">
					...
					<div class="codegear--header-column codegear--header-logo">
						<div class="codegear-branding">
							<a href="<?php echo esc_url( 'https://codegearthemes.com/' ); ?>" target="_blank">
								<img width="220px" src="<?php echo esc_url( get_template_directory_uri() . '/assets/admin/src/logo.png' ); ?>" alt="<?php esc_attr_e( 'CodeGearThemes', 'startupx' ); ?>">
							</a>
						</div>
					</div>
				</div>
				...
				<div class="codegear--header-right">
					<a href="<?php echo esc_url( $this->settings['documentation_link'] ); ?>" class="codegear--documentation-link" target="_blank">
						<span><?php esc_html_e( 'Documentation', 'startupx' ); ?></span>
						...
						<div class="content-inner">
							<div class="block-features">
								<div class="feature-tab">
									<h3 class= "feature-tab-title"><?php echo esc_html_e( 'Theme Features', 'startupx' ); ?></h3>
								</div>
								<div class="feature-content">
									<div class="feature-content-list">
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( 'Typography', 'startupx' ); ?></div>
												<div class = "sub-feature">
													<?php echo esc_html_e( 'Unlimited Google Fonts', 'startupx' ); ?>
												</div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( 'Two Selective Container', 'startupx' ); ?></div>
												<div class = "sub-feature"> <?php  echo esc_html_e( 'Fixed & Full Width', 'startupx' ); ?></div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( 'Colors', 'startupx' ); ?></div>
												<div class = "sub-feature">
													<?php  echo esc_html_e( 'Primary & Secondary', 'startupx' ); ?>
												</div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( '5 Social Profiles', 'startupx' ); ?></div>
												<div class = "sub-feature">
													<?php  echo esc_html_e( 'Facebook, Twitter, Linkedin, Instagram & Youtube', 'startupx' ); ?>
												</div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( 'Archive Layout Options', 'startupx' ); ?></div>
												<div class = "sub-feature">
													<?php  echo esc_html_e( 'Simple & Grid ', 'startupx' ); ?>
												</div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( 'Post , Page , Single Layout', 'startupx' ); ?></div>
												<div class = "sub-feature">
													<?php  echo esc_html_e( 'Left Sidebar, Right Sidebar and No Sidebar', 'startupx' ); ?>
												</div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
										<div class="list-row">
											<div class="feature-name">
												<div class="main-feature"><?php  echo esc_html_e( 'Footer Options', 'startupx' ); ?></div>
												<div class = "sub-feature">
													<?php echo esc_html_e( 'Footer Widgets Column Disabled and Enable', 'startupx' ); ?>
												</div>
											</div>
											<span class="badge badge-success"><?php echo esc_html_e( 'free', 'startupx'); ?></span>
										</div>
						...
						<div class="secondary">
							<div class="panel">
								<div class="panel-head">
									<h3 class="panel-title"><?php echo esc_html_e( 'Review', 'startupx'); ?></h3>
								</div>
								<div class="panel-content">
									...
									<p class="description"><?php echo esc_html_e( 'It makes us happy to hear from our users. We would appreciate a review.', 'startupx'); ?></p>
									<div class="action-button">
										<a href="<?php echo esc_url( $this->settings['review_link'] ); ?>" class="button button-secondary" target="_blank"><?php echo esc_html_e( 'Submit a Review', 'startupx'); ?></a>
									</div>
							...
							<div class="panel">
								<div class="panel-head">
									<h3 class="panel-title"><?php echo esc_html_e( 'Changelog', 'startupx'); ?> <?php echo esc_html( STARTUPX_THEME_VERSION ); ?></h3>
								</div>
								<div class="panel-content">
									<p class="description"><?php echo esc_html_e( 'Keep informed with the latest changes about each theme.', 'startupx' ); ?></p>
									<div class="action-button">
										<a href="<?php echo esc_url( $this->settings['changelog_link'] ); ?>" target="_blank"><?php echo esc_html_e( 'See the Changelog', 'startupx'); ?></a>
									</div>
								</div>
							</div>
						</div>
