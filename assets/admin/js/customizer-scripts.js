(function($) {
	...
	$(function() {
		...
		$('.customize-control-startupx-tabs-control').each(function () {
			$(this).parent().find('li').not('.section-meta').not('.customize-control-startupx-tabs-control').addClass('hide-control');
			...
			$(this).find('.control-tab').on('click', function () {
				...
				$(this).parent().parent().parent().find('li').not('.section-meta').not('.customize-control-startupx-tabs-control').addClass('hide-control');
