<?php
class Startupx_Control_Typography extends WP_Customize_Control {
	/**
	 * The type of control being rendered
	 */
	public $type = 'startupx-google-fonts';
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'select2', STARTUPX_THEME_URI . 'includes/customizer/controls/typography/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
		wp_enqueue_style( 'select2', STARTUPX_THEME_URI . 'includes/customizer/controls/typography/css/select2.min.css', array(), '4.0.13', 'all' );
	}		
	...
	public function render_content() {
		...
		if( !empty($this->fontList) ) {
			...
			<div class="google_fonts_select_control">
				...
				<div class="font--weight-regular" style="margin: 0 -1%;">
					<?php if ( $this->input_attrs['disableRegular'] == false ) : ?>
					<div class="font-weight">
						<div class="font-control-title"><?php esc_html_e( 'Font weight', 'startupx' ) ?></div>
				...
				<div class="font--weight-medium" style="margin: 0 -1%;">
					<div class="font-weight">
						<div class="font-control-title"><?php esc_html_e( 'Font weight medium', 'startupx' ) ?></div>
						<div class="weight-style">
				...
				<div class="font--weight-bold" style="margin: 0 -1%;">
				
					<div class="font-weight">
						<div class="font-control-title"><?php esc_html_e( 'Font weight bold', 'startupx' ) ?></div>
						<div class="weight-style">
	...
	public function get_google_fonts( $count = 30 ) {
		$fontFile = STARTUPX_THEME_URI. 'includes/customizer/controls/typography/google-fonts-alphabetical.json';
